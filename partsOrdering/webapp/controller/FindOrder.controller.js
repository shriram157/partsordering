sap.ui.define([
	...
	return BaseController.extend("tci.wave2.ui.parts.ordering.controller.FindOrder", {
		...
		onEdit: function (oEvent) {
			...
			var viewModel = this.getModel(CONST_VIEW_MODEL);
			sap.ui.getCore().setModel(viewModel,"viewModel");                                      //changes by Swetha for DMND004095 on 25th Jan, 2024.
			...
			if (obj.isSalesOrder) {
				this.getRouter().navTo("CreateOrder", {
					...
					orderType: '-1',
					navFrom: 7
				//	CPORCB:sap.ui.getCore().getModel("CPORCBModel").oData                             //changes by Swetha for DMND004095 on 25th Jan, 2024.
				});
			} else {
				this.getRouter().navTo("CreateOrder", {
					...
					navFrom: 7
					//CPORCB:sap.ui.getCore().getModel("CPORCBModel").oData
				});
			}
		},
